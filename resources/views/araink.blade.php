<x-welcome-layout>
    @section('title') {{'- Áraink'}} @endsection
    ...
    <div class="fiveSection w-full relative bg-white pb-36">
        ...
        <div class="parallax min-h-[300px] pb-[100px]" style="background-image: url({{ asset('covers/lama-min.jpg') }});"></div>

        <div class="container mx-auto text-left py-12">
            <h1 class="text-4xl  py-4 text-center">Áraink</h1>
            <div class="w-full flex justify-center">
                <div class="w-fit rounded-xl">
                    <table class="table-auto border-2 border-[#2174fa] rounded-xl text-sm md:text-lg">
                        <tbody>
                            @foreach ($prices as $price)
                                <tr>
                                    <td class="border border-[#2174fa] py-2 pl-4 pr-16 font-bold">{{ $price->name }}</td>
                                    <td class="border border-[#2174fa] py-2 pl-4 pr-16">{{ $price->price }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
