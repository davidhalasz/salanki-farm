<x-welcome-layout>
    ...
    <div class="fiveSection w-full relative bg-white pb-36">
        ...
        <div class="container mx-auto text-left py-12">
            <h1 class="text-4xl boldInter py-4 customGreen text-center">Árlista</h1>
            <div class="w-full flex justify-center">
                <div class="w-fit card p-8 rounded-xl">
                    <table class="table-auto rounded-xl text-lg text-gray-500">
                        <tbody>
