<x-welcome-layout>
    ...
    <div class="thirdSection w-full relative bg-white pb-32">
        ...
        <div class="container mx-auto text-left py-12">
            <h1 class="text-4xl py-8 text-center">Szolgáltatások</h1>
            <div class="grid grid-cols-2 gap-4 px-2">
                @foreach ($services as $service)
                    @if ($loop->index % 2 == 0)
                        <div class="flex justify-end items-center">
                            <div class="flex flex-col">
                                <h2 class="text-xl md:text-2xl lg:text-3xl font-bold">{{ $service->name }}</h2>
                                <p class="text-md lg:text-lg">{{ $service->description }}</p>
                            </div>
                        </div>
                        <div class="h-80px md:h-[150px] lg:h-[200px] aspect-[4/2]">
                            <img class="w-full h-full object-cover rounded-xl" src="{{ asset('storage/' . $service->filepath) }}">
                        </div>
                    @else
